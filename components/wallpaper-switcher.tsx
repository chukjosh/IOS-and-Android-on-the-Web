...
const wallpaperOptions = [
  { id: "yellow", name: "Sunny Yellow", gradient: "linear-gradient(135deg, #fbbf24 0%, #f59e0b 100%)" },
  { id: "purple", name: "Royal Purple", gradient: "linear-gradient(135deg, #a855f7 0%, #7c3aed 100%)" },
  { id: "azure", name: "Ocean Azure", gradient: "linear-gradient(135deg, #3b82f6 0%, #06b6d4 100%)" },
...
export function WallpaperSwitcher() {
  ...
  const handleWallpaperChange = (wallpaperId: string) => {
    setWallpaper(wallpaperId as any)
    setIsOpen(false)
  }
              ...
              <div className="p-2">
                ...
                {wallpaperOptions.map((option) => (
                  ...
                  >
                    ...
                    {wallpaper === option.id && (
                      <div className={`ml-auto w-2 h-2 rounded-full ${isDark ? "bg-blue-400" : "bg-blue-500"}`} />
                    )}
                  </button>
                ))}
              </div>
